...
class CoreWorkload {
 public:
  ...
  void AppendHotspot(const std::string &start, const std::string &end) {
    hotspots_.push_back(std::make_pair(start, end));
  }
  ...
  std::vector<std::pair<std::string, std::string>> hotspots_;
