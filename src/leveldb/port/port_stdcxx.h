...
#ifndef PORT_STDCXX_FROM_WOT_NAMESPACE_H_
#define PORT_STDCXX_FROM_WOT_NAMESPACE_H_
...
#if __has_include("leveldb/port/port_config.h")
#include "leveldb/port/port_config.h"
...
#endif  // PORT_STDCXX_FROM_WOT_NAMESPACE_H_
