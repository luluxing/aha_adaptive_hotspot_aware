...
void Table::ReadMeta(const Footer& footer) {
  ...
  ReadOptions opt;
  // we do not check this; to be consistent with table/format.cc
...
void Table::ReadFilter(const Slice& filter_handle_value) {
  ...
  rep_->filter = new FilterBlockReader(NewBloomFilterPolicy(10), block.data);
}
