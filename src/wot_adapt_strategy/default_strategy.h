...
class DefaultAdapt {
 public:
  ...
  virtual bool HasTargetData(const std::string& lk, const std::string& uk, LevelDBLSMT*);
...
class HotOnlyAdapt : public PriorityNoDupAdapt {
 public:
  ...
  bool HasTargetData(const std::string& lk, const std::string& uk, LevelDBLSMT* lsmt) override;
