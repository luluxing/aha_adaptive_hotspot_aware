...
#ifndef ENV_FROM_LEVELDB_INCLUDE_WOT_NAMESPACE_H_
#define ENV_FROM_LEVELDB_INCLUDE_WOT_NAMESPACE_H_
...
class Env {
 public:
  ...
  // a new shcedule function for push down background work
  virtual void SchedulePushdown(void (*function)(void* arg), void* arg) = 0;
  virtual void ScheduleTreeInsert(void (*function)(void* arg), void* arg) = 0;

  virtual bool CompactionWorkRunning() = 0;
  virtual bool PushdownWorkRunning() = 0;
