...
: tree_(new BtreeOLC(options)),
  hot_queried_start_((*options)["hot_queried_start"]),
  hot_queried_end_((*options)["hot_queried_end"]),
  interval_(0) {}
